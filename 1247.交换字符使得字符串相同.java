...
class Solution {
    public int minimumSwap(String s1, String s2) {
        ...
        // impossible
        // (1) there should be even numbers of those types of exchanges, in which the
        // first strategy suffices. OR
        // (2) there should be odd numbers of those types of exchanges, in which we
        // apply the fisrt strategy
